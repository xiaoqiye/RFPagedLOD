...
namespace hivePagedLOD
{
	...
	public:
		~CScene();
		bool init(const std::string& vSerializedPath, const std::string& vBinFolderPath, bool vLegalTileName = false, unsigned int vBeginTileNumber = 1, unsigned int vEndTileNumber = 0, int vTraverseMaxDeep = -1);
