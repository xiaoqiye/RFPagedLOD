...
{
	auto pPipelineV2P = std::make_shared<CPipelineToPreferredTileNodeGenerator>();
	...
	CScene::getInstance()->init(LODTREE_FOLDER_PATH, BIN_FOLDER_PATH, true, 1, 1);
