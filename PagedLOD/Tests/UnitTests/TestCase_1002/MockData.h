...
namespace MockData
{
	const std::vector<std::shared_ptr<hivePagedLOD::CTileNode>> getTileNodeSet()
	{
		...
		TileNode0->setCreatedByFileName("Node0");
		...
		TileNode1->setCreatedByFileName("Node1");
		...
		TileNode2->setCreatedByFileName("Node2");
		...
		TileNode3->setCreatedByFileName("Node3");
		...
		TileNode4->setCreatedByFileName("Node4");
		...
		TileNode5->setCreatedByFileName("Node5");
		...
		TileNode6->setCreatedByFileName("Node6");
	...
	std::vector<std::shared_ptr<hivePagedLOD::CTileNode>> getExceptResultSet()
	{
		...
		Node0->setCreatedByFileName("Node0");
		Node1->setCreatedByFileName("Node1");
		Node2->setCreatedByFileName("Node2");
		Node3->setCreatedByFileName("Node3");
		Node4->setCreatedByFileName("Node4");
		Node5->setCreatedByFileName("Node5");
	...
	static bool isSameTileNode(const std::shared_ptr<hivePagedLOD::CTileNode>& vTileNode1, const std::shared_ptr<hivePagedLOD::CTileNode>& vTileNode2)
	{
		...
		return vTileNode1->getCreatedByFileName() == vTileNode2->getCreatedByFileName();
	}
}